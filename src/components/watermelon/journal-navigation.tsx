...
export const JournalNavigation: React.FC<JournalNavigationProps> = ({
  ...
  return (
    <div className="flex min-h-full w-full flex-col items-center justify-center bg-transparent p-6 transition-colors duration-500">
      <div className="relative flex h-85 w-full max-w-90 overflow-hidden rounded-4xl border border-[#e5e4de]/50 bg-[#F3EFE9] shadow-sm transition-colors duration-300 select-none dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <div className="relative flex-1">
              <AnimatePresence>
                <motion.div
                  ...
                  animate="center"
                  exit="exit"
                  className="absolute top-0 left-0 w-full text-[18px] leading-relaxed font-bold tracking-tight text-[#292422] transition-colors dark:text-neutral-200"
                >
